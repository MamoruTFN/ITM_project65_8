...
channel_secret = '114eda2507198b65fe7b3097f8e6bf2f'
channel_access_token = 'O6URXu41B2HVAA+rsEMpXSK+R4QygJnGYccSqk83MTt5tb/BcOo0uu2Lv6Ug5/gWpUa3e7hmEzS9TvMa3L9ghgCYzfNTWkLUxJds1ydk1n1r/ltKqYnhlQkVugmBCAMIJ4uF5Jh1ED1JVL5h6qFibwdB04t89/1O/w1cDnyilFU='
...
model = load_model(r'C:\Users\pokpo\anaconda3\envs\mit\New folder\model\modelEnd.h5')
# Other Message Type
...
def handle_content_message(event):
    ...
    line_bot_api.reply_message(
        event.reply_token, [
            TextSendMessage(text='หมอสตอเบอรี่ได้วินิจฉัยว่า: '),
            ImageSendMessage(url,url)
